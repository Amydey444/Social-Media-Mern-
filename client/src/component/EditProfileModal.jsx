...
const EditProfileModal = () => {
    ...
    const updateUser = async () =>{
        try {
            const response = await axios.patch(`${import.meta.env.VITE_API_URL}/users/edit`,userData,
            {withCredentials:true, headers: { Authorization: `Bearer ${token}` }})
            closeModal()
        ...
        <section className='editProfile' onClick={e => closeModal(e)}>
            <div className='editProfile__container'>
                ...
                <form onSubmit={updateUser}>
                    <input type='text' name='fullName' value={userData?.fullName} onChange={changeUserData}
